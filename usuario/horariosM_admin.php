                ...
                <div class="login">
                    ...
                    if (!empty($medicos)) {
                        ...
                        foreach ($medicos as $medico) {
                            ...
                            echo "<td>
                            <a href='telahorariosMedico_admin.php?cpf=" . $medico['cpf'] . "' class='btn btn-success'><i class='bi bi-calendar'></i></a>  <!-- Botão De Acesso As Agendas -->                            
                            </td>";
                            echo "</tr>";
                        }
                        echo "</table>";
