...
<?php
include_once("../usuario/validarMedico.php");
        ...
        <div class="container" >
            <div class="login">
                ...
                if (!empty($medicos)) {
                    ...
                    echo "<table border='1'>";
                    echo "<tr><th>CPF</th><th>CRM</th><th>Nome</th><th>Especialidade</th><th>Contato</th><th>Email</th><th>Endereço</th><th style='text-align: center;'> <span style='float: left;''>Ações</span> </th></tr>";
                    ...
                    foreach ($medicos as $medico) {
                        ...
                        echo "<td>
                            <a href='telahorariosmedico.php?cpf=".$medico['cpf']."' class='btn btn-success'><i class='bi bi-calendar'></i></a>  <!-- Botão De Acesso As Agendas -->                            
                            </td>";
                        echo "</tr>";
                    }
                    echo "</table>";   
